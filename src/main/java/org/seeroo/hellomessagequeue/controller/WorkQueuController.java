...
import org.seeroo.hellomessagequeue.producer.WorkQueueProducer;
...
public class WorkQueuController {
    ...
    public String workQueue(@RequestParam("message") String message, @RequestParam("duration") int duration) {
